...
@section('title', 'Choose Your Diet')
...
<form id="meal-plan-form" action="" method="GET" class="mb-8">
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <label class="diet-card cursor-pointer">
                ...
                <div class="border-2 rounded-lg p-4 transition-all peer-checked:border-green-500 peer-checked:bg-green-50 hover:border-green-300">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div class="max-w-xs">
            ...
            <select name="servings" id="servings" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 text-lg p-3 border">
    ...
    <div class="text-center">
        <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-8 rounded-lg text-xl transition-colors shadow-lg">
...
<div class="bg-green-50 rounded-lg p-6 mt-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="text-center">
            <div class="bg-green-600 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3 text-xl font-bold">1</div>
        ...
        <div class="text-center">
            <div class="bg-green-600 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3 text-xl font-bold">2</div>
        ...
        <div class="text-center">
            <div class="bg-green-600 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3 text-xl font-bold">3</div>
